...
public class QList {
    ...
    public ArrayList<String> Q_Array = new ArrayList(Arrays.asList(questions));
    public ArrayList<String> Q_Array2 = new ArrayList(Arrays.asList(questions));
    ...
    public void select(int i) {
        Select_Array.add(answer[Q_Array2.indexOf(Q_Array.get(i))]);
        shuffleA_Array();
        for (int p = 0; p < 3; p++) {
    ...
    void remove(int i) {
        ...
        remove_answer = answer[Q_Array2.indexOf(Q_Array.get(i))];
    ...
    void solve(int i) {
        qComparison.input();
        if (Select_Array.indexOf(Q_Array.get(i)) == qComparison.Select_Answer) {
            System.out.println("正解！！");
        } else {
            System.out.println("残念！！不正解");
            System.out.println("正解は" + answer[Q_Array2.indexOf(Q_Array.get(i))]);
        }
