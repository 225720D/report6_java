...
// qComparison.input();
// if
// (qList.Select_Array.indexOf(qList.answer[qList.Q_ArrayIndex.indexOf(qList.Q_ArrayShuffle.get(i))])
...
// System.out.println(qList.Q_ArrayIndex);
// System.out.println(qList.Q_ArrayShuffle.get(i));
// System.out.println(qList.Q_ArrayShuffle);
